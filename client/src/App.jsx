...
// Component to handle first-time user redirection
const AppRoutes = () => {
  const { isAuthenticated, isLearner, hasCompletedPersonalization } = useAuth();

  // Redirect first-time students to personalization
  if (isAuthenticated && isLearner && !hasCompletedPersonalization()) {
    return (
      <div className="App">
        <Header />
        <Routes>
